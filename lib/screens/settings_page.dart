...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CityProvider>(builder: (context, value, child) {
      return Scaffold(
        appBar: AppBar(
          iconTheme: IconThemeData(color: value.appBarItemsColor),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Radio(
                      ...
                      groupValue: AppStateContainer.of(context).temperatureUnit,
                      onChanged: (value) {
                        AppStateContainer.of(context)
                            .updateTemperatureUnit(value as TemperatureUnit);
                      },
                      activeColor: appTheme.colorScheme.secondary,
                    )
                  ],
...
//                             TemperatureUnit.values[intToDouble(value)]);
//                       },
//                       activeColor: appTheme.colorScheme.secondary,
//                     )
//                   ],
